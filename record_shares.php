...
<head>
    ...
    <title>Ndalama Village Bank - Record Shares</title>
...
<body>
    ...
    if (isset($_POST['record_share'])) {
        $member_id = mysqli_real_escape_string($conn, $_POST['member_id']);
        $amount = mysqli_real_escape_string($conn, $_POST['amount']);
        $sql = "INSERT INTO shares (member_id, amount, date) VALUES ('$member_id', '$amount', CURDATE())";
        if (mysqli_query($conn, $sql)) {
            echo "<script>alert('Share recorded successfully');</script>";
        } else {
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="record_shares.php">Record Shares</a></li>
    ...
    <div class="container mt-4">
        ...
        <form method="POST" class="p-4 bg-white shadow rounded">
            ...
            <button type="submit" name="record_share" class="btn btn-primary">Record Share</button>
        </form>
    </div>
